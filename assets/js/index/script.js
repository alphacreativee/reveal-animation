document.addEventListener("DOMContentLoaded", () => {
  ...
  const splitTextIntroLines = (selector, options = {}) => {
    const defaults = {
      type: "lines",
      mask: "lines",
      lineClass: "line",
  ...
  splitTextIntroLines(".preloader-copy p");
  splitTextIntroLines(".preloader-counter p");
    ...
    setTimeout(() => {
      const updateCounter = () => {
        ...
        if (currentValue < 100 && elapsedTime < maxDuration) {
          ...
          currentValue = Math.min(currentValue + jump, 100);
